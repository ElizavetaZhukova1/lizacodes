  ...
  return (
    <div className="bg-black_bg text-white_bg py-6 grid grid-cols-2 px-10">
        <div className="flex flex-col">  
            <div className="relative font-head_text text-6xl mb-6 text-center">
    ...
    <img
          ...
          className="object-left justify-start items-start object-contain"
          style={{ maxWidth: '300px', zIndex:20 }} // Adjust the size as needed
        />
    <img
          src={LinkPhoto}
          alt="Liza's LinkedIn Portrait"
          className="object-right justify-end items-end object-contain"
          style={{ maxWidth: '300px', zIndex:10 }} // Adjust the size as needed
        />
    </div>
