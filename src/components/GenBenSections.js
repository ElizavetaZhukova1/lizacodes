...
const GenBenSections = ({firstHead, firstPar, secondHead, secondPar, thirdHead, thirdPar}) => {
  return (
    ...
    <div className="md:grid md:grid-cols-3 xs:max-md:flex md:justify-around md:items-left xs:max-md:flex-col xs:max-md:justify-evenly xs:max-md:items-center xs:max-md:space-x-4 mx-10 mt-10 mb-4 text-black_bg">
